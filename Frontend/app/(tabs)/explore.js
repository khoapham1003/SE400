...
var ExploreScreen = function (props) {
    ...
    return (<>
      ...
      <react_native_1.View style={[styles.container, { marginTop: headerHeight }]}>
        <react_native_1.FlatList data={categories} showsHorizontalScrollIndicator={false} keyExtractor={function (item) { return item.id.toString(); }} renderItem={function (_a) {
            var item = _a.item, index = _a.index;
            return (<react_native_reanimated_1.default.View style={styles.itemWrapper} entering={react_native_reanimated_1.FadeInDown.delay(300 + index * 100).duration(500)}>
              <react_native_1.Text style={styles.itemTitle}>{item.title}</react_native_1.Text>
              <react_native_1.Image source={{ uri: item.picture }} style={{ width: 100, height: 100, borderRadius: 10 }}/>
